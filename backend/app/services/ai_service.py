    ...
    if llm:
        try:
            ...
            if uploaded_image_bytes:
                ...
                response = llm.chat.completions.create(model="openai/gpt-oss-20b", messages=messages)
...
def summarize_notes_ai(note_title: str, content_text: str, subject_name: str) -> Dict[str, Any]:
    ...
    if llm:
        try:
            ...
            response = llm.chat.completions.create(model="openai/gpt-oss-20b", messages=messages, response_format={"type": "json_object"})
